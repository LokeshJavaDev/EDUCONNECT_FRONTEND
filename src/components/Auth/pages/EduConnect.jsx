...
import { BookOpen, Home, Video, Award, Bell, LogOut, Menu, X, Play, Clock, Users, Star, TrendingUp, Search, Plus, ChevronRight, User } from 'lucide-react';
...
const COURSES = [
    ...
    },
    {
        ...
        description: "Learn Python, Machine Learning, Deep Learning from scratch",
    ...
    },
    {
        ...
        description: "Create stunning interfaces with Figma and modern design principles",
...
const EduConnect = () => {
    ...
    const user = {
        firstName: 'Lokesh',
        lastName: 'Lohmor',
        email: 'lokeshchhara.mdu@gmail.com'
    };
        ...
        <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:relative z-50 w-72 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white h-screen flex flex-col transition-transform duration-300 shadow-2xl`}>
                ...
                <div className="p-4 border-t border-gray-700">
                    <button className="w-full flex items-center gap-3 px-4 py-4 rounded-xl hover:bg-red-600/90 transition-all duration-300 group">
